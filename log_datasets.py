...
def fake_data(data_divisor, input_path, output_path):
    i = 0
    ent_fa = int(153070)  # number of fake artists
    ent_fc = int(176449)  # number of fake creators
    ent_fl = int(203236)  # number of fake locations
    ...
    last_entities(rel_path, fake_jsons_path + '/', floor, file_name.replace('/', ''))
